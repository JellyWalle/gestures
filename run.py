...
GestureRecognizerOptions = mp.tasks.vision.GestureRecognizerOptions(base_options=Base_options,
                                                                    num_hands=2,
...
while cap.isOpened():
    ...
    result = detector.recognize_for_video(mp_image,timestamp_ms = i*4)
    i+=1
    print(result)
